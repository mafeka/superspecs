...
**Input**: `$ARGUMENTS` — whatever the user wants to think about: a vague
idea, a specific problem, an existing change name to explore further, a
comparison between approaches, or nothing (just enter the mode).
