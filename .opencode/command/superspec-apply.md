...
3. Dispatch an implementer subagent using
   `.opencode/superspec/implementer-prompt.md`, filled with this task's
...
6. Dispatch a task reviewer using
   `.opencode/superspec/task-reviewer-prompt.md`, filled with the same
...
3. Dispatch the final reviewer using
   `.opencode/superspec/final-reviewer-prompt.md` — fresh subagent, no
